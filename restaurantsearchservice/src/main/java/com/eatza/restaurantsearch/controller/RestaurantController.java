...
public class RestaurantController {
	...
	@GetMapping("/res/restaurants/name/{name}")
	...
	@GetMapping("/res/restaurants/location/{location}/cuisine/{cuisine}")
	...
	@GetMapping("/res/restaurants/name/{name}/location/{location}")
	...
	@GetMapping("/res/restaurants/budget/{budget}")
	...
	@GetMapping("/res/restaurants/rating/{rating}")
	...
	@GetMapping("/res/restaurant/items/{restaurantid}")
